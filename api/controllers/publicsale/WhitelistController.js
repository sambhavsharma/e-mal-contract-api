...
module.exports = {
    ...
    check: function(req, res){
        whitelist_status = Web3Service.eMalPublicsale.isWhitelisted(req.param('investor_addr'));
        return res.status(200).json({status: 'success', whitelist_status: whitelist_status});
    },

    // Add address to whitelist
    add: function(req, res){
        Web3Service.eMalPublicsale.addToWhitelist
    ...
    remove: function(req, res){
        Web3Service.eMalPublicsale.removeFromWhitelist
            .sendTransaction(req.param("investor_addr"));
        return res.status(200).json({status: 'success' });
    }
}